...
class ESitemapModel extends CModel {
     ...
     * @return ActiveRecord[] The extended active record classes to be used
     */
    public function getModels() {
        $scope = $this->scopeName;
        return ActiveRecord::model($this->baseModel)->$scope()->findAll();
    }
     ...
     * for a given model.
     * 
     * @param ActiveRecord $model The model whose attributes should be used to
